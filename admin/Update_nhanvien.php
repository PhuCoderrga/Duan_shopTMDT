                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="w-75">
                                                            <img src="./img/<?php echo $p->laycot("SELECT Hinh FROM nhanvienvandon WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}'"); ?>"
                                                                alt="Cập nhập ảnh đi" class="rounded-circle w-25">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="w-75">
                                                            <input type="text" name="HoTen" id="HoTen" class="w-50"
                                                                value="<?php echo $p->laycot("SELECT HoTen FROM nhanvienvandon WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}'"); ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="w-25"><label for="SDT">SỐ ĐIỆN THOẠI:</label>
                                                        </td>
                                                        <td class="w-75">
                                                            <input type="text" name="SDT" id="SDT" class="w-50"
                                                                value="<?php echo $p->laycot("SELECT SDT FROM nhanvienvandon WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}'"); ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="w-75">
                                                            <input type="text" name="DiaChi" id="DiaChi" class="w-100"
                                                                value="<?php echo $p->laycot("SELECT DiaChi FROM nhanvienvandon WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}'"); ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                    ...
                                                                    case 'Thêm Danh Mục': {
                                                                        ...
                                                                        if ($layid > 0) {
                                                                            if ($name != '') {
                                                                                ...
                                                                                if($p->themxoasua("UPDATE nhanvienvandon SET `HoTen` = '$HoTen', `DiaChi` = '$DiaChi', `SDT` = '$SDT', `Hinh` = '$name' WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}' LIMIT 1 ;")==1){
                                                                                    echo " 
                                                                                        <script>
                                                                                            location.reload();
                                                                                            window.location.href = './Update_nhanvien.php?id=$layid';
                                                                                            alert('Cập Nhập Thành Công');
                                                                                        </script>";
                                                                                }
                                                                            } else {
                                                                                if($p->themxoasua("UPDATE nhanvienvandon SET `HoTen` = '$HoTen', `DiaChi` = '$DiaChi', `SDT` = '$SDT' WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}' LIMIT 1 ;")==1)
                                                                                {
                                                                                    echo "
                                                                                    <script>
                                                                                        location.reload();
