                                            ...
                                            <table class="w-100">
                                                <tbody class="w-100">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="w-75">
                                                            <?php echo $p->laycot("SELECT HoTen FROM nhanvientuvan WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}'"); ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="w-75">
                                                            <?php echo $p->laycot("SELECT DiaChi FROM nhanvientuvan WHERE TaiKhoan = '{$_SESSION['TaiKhoan']}'"); ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="w-100 text-left" colspan="2">
                                                            ...
                                                            <a class="btn btn-info"
                                                                href="Update_nhanvien_TV.php?id=<?php echo $_SESSION['id'] ?>"
                                                                role="button">
                                                                Cập nhập thông tin
                                                            </a>
                                                        </td>
