...
session_start();
    if (isset($_SESSION['TaiKhoan']) && isset($_SESSION['MatKhau']) && isset($_SESSION['PhanQuyen']) && isset($_SESSION['unique_id'])) {
        ...
        // init configuration
        $clientID = '554658854995-lg3fasb2lfvb59p9eect60e2l1p6v499.apps.googleusercontent.com';
        $clientSecret = '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';
        $redirectUri = 'https://duanshop.phugacoder.pw/signin.php';
